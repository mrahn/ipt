// multiple-survey-4-overlap (pos-mix).
//
// Hit-vs-miss pos benchmark.  No environment variables; SEED_COUNT
// hard-coded.  Output lines are aggregated by results/plot/pos-mix-summary.cpp.
//
#include <cstdint>
#include <cstdlib>
#include <exception>
...
auto main() noexcept -> int try
{
  ...
  auto const sink {run_seeds_pos_mix (data, "multiple-survey-4-overlap", SEED_COUNT)};
