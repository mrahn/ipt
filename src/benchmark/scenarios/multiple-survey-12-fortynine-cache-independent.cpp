// multiple-survey-12-fortynine (cache-independent).
//
// Generated wrapper for the multiple-survey-12-fortynine scenario.  No environment variables; constants
...
auto main() noexcept -> int try
{
  ...
  auto const data {multiple_survey_12_fortynine()};
