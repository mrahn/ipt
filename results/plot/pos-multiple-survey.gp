# Plot: pos_random absolute performance for multiple-survey scenarios.
set encoding utf8
set terminal cairolatex pdf size 6.0in,3.8in
set output 'generated/pos-multiple-survey.tex'

set ylabel 'ns / \texttt{pos}'
set y2label 'M\texttt{pos} / s'
...
plot 'results/plot/pos-multiple-survey.tsv' \
