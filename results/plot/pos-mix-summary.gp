...
set title 'in-grid'
set ylabel 'ns / \texttt{try\_pos}'
plot 'results/plot/pos-mix-summary.tsv' \
         u 1:2  w lp title 'IPT'                     lt 1, \
    ''  u 1:3  w lp title '\textsc{SortedPoints}'   lt 2, \
    ''  u 1:4  w lp title '\textsc{DenseBitset}'    lt 3, \
    ''  u 1:5  w lp title '\textsc{BlockBitmap}'    lt 4, \
    ''  u 1:6  w lp title '\textsc{Roaring}'        lt 5, \
    ''  u 1:7  w lp title '\textsc{LexRun}'         lt 6, \
    ''  u 1:8  w lp title '\textsc{RowCSR}\textsubscript{1}' lt 7, \
    ''  u 1:9  w lp title '\textsc{RowCSR}\textsubscript{2}' lt 8
...
plot 1/0 w lp title 'IPT'                     lt 1, \
    1/0 w lp title '\textsc{SortedPoints}'   lt 2, \
    1/0 w lp title '\textsc{DenseBitset}'    lt 3, \
    1/0 w lp title '\textsc{BlockBitmap}'    lt 4, \
    1/0 w lp title '\textsc{Roaring}'        lt 5, \
    1/0 w lp title '\textsc{LexRun}'         lt 6, \
    1/0 w lp title '\textsc{RowCSR}\textsubscript{1}' lt 7, \
    1/0 w lp title '\textsc{RowCSR}\textsubscript{2}' lt 8
