// multiple-survey-11-thirtysix (cache-independent).
//
// Generated wrapper for the multiple-survey-11-thirtysix scenario.  No environment variables; constants
...
auto main() noexcept -> int try
{
  ...
  auto const data {multiple_survey_11_thirtysix()};
