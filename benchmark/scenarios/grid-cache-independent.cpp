// Grid sweep, cache-independent algorithms.
//
// Iterates 4 cube grids x {regular, 12 random densities} x 30 seeds.
// Runs the LIGHT cache-independent baselines only (sorted-points,
// lex-run, row-csr-k1, row-csr-km, grid).  No environment variables; reference
// cache combination is selected at compile time.
//
#include <array>
#include <cstdint>
#include <cstdlib>
