...
\caption{Absolute \texttt{pos} performance on the multiple-survey
  ...
  repetitions).}
\Description{A bar chart comparing absolute pos query performance for IPT and SortedPoints across the nine structured multiple-survey scenarios on the EPYC 9454 reference platform, with 10th-to-90th-percentile error bars across the 5 repetitions.}
...
\caption{Absolute \texttt{at} performance on the multiple-survey
  ...
  error bars spanning the 10th-90th percentile across the 5
  repetitions).}
\Description{A bar chart comparing absolute at query performance for IPT and SortedPoints across the nine structured multiple-survey scenarios on the EPYC 9454 reference platform, with 10th-to-90th-percentile error bars across the 5 repetitions.}
