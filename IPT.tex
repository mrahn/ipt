...
(executed by \texttt{run/benchmark-stress.sh}). It places a $3\times 4$
...
\texttt{ipt/}; the benchmark driver is the single translation unit
\texttt{benchmark.cpp}; the per-figure extractors and gnuplot scripts
are colocated in \texttt{plot/}; aggregated tabular outputs land in
\texttt{generated/}. Citation metadata for the artifact is provided in
\texttt{CITATION.cff}.
